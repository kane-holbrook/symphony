...
local PANEL = xvgui.RegisterFromXML("Window", [[
    <Rect 
        ...
        FillColor="Color(255, 255, 255, 16)"
        FillRepeatX="true"
        FillRepeatY="true"
        ...
        ShowHeader="true"
        StrokeWidth="1"
        StrokeColor="Color(158, 200, 213, 16)"
    >         
        <Rect 
            Ref="Header"
            :Display="ShowHeader"
            ...
            :On:Click="function (...) Window:StartMove() end"
        >
            ...
            <Rect Flex="9" Height="1ph" Direction="Y" Gap="2ss" MarginLeft="8cw" :Display="Closeable">
                <Rect Slot="HeaderButtons">
                    <Rect :On:Click="function (...) Window:Remove() end" Hover="true" Cursor="hand" StrokeWidth="1" Width="1.5cw" Height="1.5cw" Radius="0.75cw" Flex="5" StrokeColor="Color(255, 255, 255, 16)" FillColor="Color(97, 0, 0, 98)" Hover:FillColor="Color(173, 0, 0)">
                    </Rect>
                </Rect>
            </Rect>
        </Rect>
        ...
        <Rect Absolute="true" Ref="SizeTL" :On:Click="function () Window:StartResize('tl') return true end" :Display="Sizeable" Cursor="sizenwse" X="0" Y="0" Width="5ss" Height="5ss">
        </Rect>
        
        <Rect Absolute="true" Ref="SizeTR" :On:Click="function () Window:StartResize('tr') return true end" :Display="Sizeable" Cursor="sizenesw" :X="self:GetParent():GetWide() - ScreenScale(4)" Y="0" Width="4ss" Height="4ss">
        </Rect>
                
        <Rect Absolute="true" Ref="SizeBR" :On:Click="function () Window:StartResize('br') return true end" :Display="Sizeable" Cursor="sizenwse" :X="self:GetParent():GetWide() - ScreenScale(4)" :Y="self:GetParent():GetTall() - ScreenScale(4)" Width="4ss" Height="4ss">
        </Rect>
        
        <Rect Absolute="true" Ref="SizeBL" :On:Click="function () Window:StartResize('bl') return true end" :Display="Sizeable" Cursor="sizenesw" X="0" :Y="self:GetParent():GetTall() - ScreenScale(4)" Width="4ss" Height="4ss">
        </Rect>
    </Rect>
]])
