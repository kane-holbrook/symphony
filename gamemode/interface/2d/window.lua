...
local PANEL = Interface.RegisterFromXML("Window", [[
    <Rect Root="true" Direction="Y" :FontColor="Color(182, 208, 216)" >
        ...
        <Rect FontName="Rajdhani" FontSize="8.5" Background="0, 0, 0, 245" Grow="true" Radius="4" Direction="Y">
            ...
            <Rect Background="0, 0, 0, 255" Ref="Header" Width="100%" :Cursor="Moveable and 'sizeall' or nil">
                <Img Width="100%" Material="sstrp25/ui/window-hazard.png" Repeat="true" Scale="0.2" TopLeftRadius="4" FillColor="32, 32, 32, 255" Flex="4" Padding="5">
                    <Rect FontName="Orbitron SemiBold" :FontColor="Color(158, 200, 213)" MarginTop="5" MarginBottom="5" FontSize="14" MarginLeft="0.5ch" MarginRight="0.5ch"><Text :Content="string.upper(Title)" /></Rect>
                </Img>
            </Rect>

            <Img Grow="true" Material="sstrp25/ui/hex.png" Repeat="true" Scale="0.2" FillColor="0, 0, 0, 255" Padding="6" MarginTop="2.5" MarginBottom="2.5" Direction="Y" Flex="7" Slot="Default">
            </Img>
