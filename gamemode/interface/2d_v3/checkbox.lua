...
local Checkbox = Interface.RegisterFromXML("Checkbox", [[
    <Rect Align="7" Flow="X" Hover="true" Cursor="hand" 
        ...
        <Rect 
            ...
            MarginRight="3cw"
        >
            <Text Content="✓" FontSize="7" :Display="Checked" />
        </Rect>
...
function Checkbox.Prototype:PerformLayout()
    ...
    if not self:GetValue() then
        ...
        assert(child and child.GetContent, "Radio must have a Text element as its child.")
